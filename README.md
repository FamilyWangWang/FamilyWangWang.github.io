...
- [mathSystem](https://familywangwang.github.io/mathSystem/) — bilingual interactive mathematics atlas with seven labs, local progress tracking, and verified A2 wall posters
...
The public `mathSystem` site is a controlled static build of its private HTML source. The build adds public metadata and accessibility fixes, blocks network access, validates every local reference, and produces one-page Chinese and German A2 PDFs. Learning progress remains only in each visitor's browser.
